...
errorsArray of strings Default: "CREATE_ACT_ERROR_REASON_UNSPECIFIED"Items Enum: "CREATE_ACT_ERROR_REASON_UNSPECIFIED" "INVALID_ORDER_TYPE" 错误原因： CREATE_ACT_ERROR_REASON_UNSPECIFIED ——未定义； INVALID_ORDER_TYPE ——无法为指定标识符创建验收证明书。 file_uuidstring 验收证明书标识符。 is_successboolean true，前提是请求中没有错误。
