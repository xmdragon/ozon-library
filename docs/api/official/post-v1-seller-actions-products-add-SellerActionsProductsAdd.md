...
action_id required integer <uint64> 促销活动标识符。请通过方法/v1/seller-actions/list获取该参数的值。 products required Array of objects <= 100 items 商品信息。
...
```json
{"action_id": 0,"products": [{"currency": "RUB","discount_percent": 0,"sku": 0}]}
```
