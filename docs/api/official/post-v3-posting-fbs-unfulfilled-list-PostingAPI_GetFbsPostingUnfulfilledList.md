...
| 2025-11-27 | `added_field` | /v3/posting/fbs/unfulfilled/list 在各方法的响应中：<br>更新了参数 result.analytics_data.payment_type_group_name 的描述；<br>新增了参数 result.analytics_data.client_delivery_date_begin 和result.analytics_data.client_delivery_date_end。 | [官方 News](https://docs.ozon.ru/api/seller/zh/#section/20251127) |
