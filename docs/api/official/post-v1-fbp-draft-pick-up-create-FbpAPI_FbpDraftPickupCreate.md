...
bundle_id required string 已校验商品列表的标识符。 delivery_details required object 配送详细信息。 package_units_count required integer <int32> 包装单位数量。 warehouse_id required integer <int64> 仓库标识符。
