...
- 官方锚点：https://docs.ozon.ru/api/seller/zh/#operation/PassList
- 分组：`pass`
...
| 日期 | 标记 | 摘要 | 来源 |
| --- | --- | --- | --- |
| 2025-06-20 | `updated` | /v1/pass/list 更新了请求示例。 | [官方 News](https://docs.ozon.ru/api/seller/zh/#section/2025620) |
