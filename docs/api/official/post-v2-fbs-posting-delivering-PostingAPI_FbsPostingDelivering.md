...
- 官方锚点：https://docs.ozon.ru/api/seller/zh/#operation/PostingAPI_FbsPostingDelivering
- 分组：`fbs`
...
| 日期 | 标记 | 摘要 | 来源 |
| --- | --- | --- | --- |
| 2025-09-24 | `updated` | /v2/fbs/posting/delivering 更新了方法描述。 | [官方 News](https://docs.ozon.ru/api/seller/zh/#section/2025924) |
