...
- 官方锚点：https://docs.ozon.ru/api/seller/zh/#operation/SellerActionsProductsCandidates
- 分组：`seller-actions`
...
| 日期 | 标记 | 摘要 | 来源 |
| --- | --- | --- | --- |
| 2026-03-24 | `new_method` | /v1/seller-actions/products/candidates 新增了用于管理卖家促销活动的Beta方法。 | [官方 News](https://docs.ozon.ru/api/seller/zh/#section/2026324) |
