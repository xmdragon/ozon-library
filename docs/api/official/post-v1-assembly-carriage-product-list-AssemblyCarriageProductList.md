...
- 官方锚点：https://docs.ozon.ru/api/seller/zh/#operation/AssemblyCarriageProductList
- 分组：`assembly`
...
| 日期 | 标记 | 摘要 | 来源 |
| --- | --- | --- | --- |
| 2025-12-30 | `graduated` | /v1/assembly/carriage/product/list 已将该方法从Beta版迁移至正式版。 | [官方 News](https://docs.ozon.ru/api/seller/zh/#section/20251230) |
