...
- 请求：`POST /v1/fbp/draft/pick-up/registrate`
- Operation ID：`FbpDraftPickUpRegistrate`
- 官方锚点：https://docs.ozon.ru/api/seller/zh/?__rr=1#operation/FbpDraftPickUpRegistrate
- 分组：`fbp`
...
row_version required integer <int64> 草稿的当前版本标识符。 supply_id required string 交货申请标识符。
