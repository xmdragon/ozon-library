...
arrival_pass_ids required Array of strings <int64> 通行证列表。 carriage_id required integer <int64> 运输ID。
...
```json
{"carriage_id": 5000123456,"arrival_pass_ids": [6000123456,6000123457]}
```
