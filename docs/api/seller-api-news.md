...
| `/v3/finance/transaction/list` | `deprecated` | 2026-07-14 | `/v1/finance/accrual/postings`, `/v1/finance/accrual/types`, `/v1/finance/accrual/by-day` | [来源](https://docs.ozon.ru/api/seller/zh/#section/2026714) |
| `/v3/finance/transaction/totals` | `deprecated` | 2026-07-14 | `/v1/finance/accrual/postings`, `/v1/finance/accrual/types`, `/v1/finance/accrual/by-day` | [来源](https://docs.ozon.ru/api/seller/zh/#section/2026714) |
| `/v3/posting/fbs/list` | `deprecated` | 2026-07-10 | `/v4/posting/fbs/list` | [来源](https://docs.ozon.ru/api/seller/zh/#section/2026710) |
| `/v3/posting/fbs/unfulfilled/list` | `deprecated` | 2026-07-10 | `/v4/posting/fbs/unfulfilled/list` | [来源](https://docs.ozon.ru/api/seller/zh/#section/2026710) |

## News 中已移除或当前索引缺失的方法

| 方法 | 标记 | 日期 | 替代方法 | 摘要 |
| --- | --- | --- | --- | --- |
| `/v2/returns/rfbs/reject` | `removed_method` | 2026-08-11 | `/v1/returns/rfbs/action/set` | /v2/returns/rfbs/reject 这些方式已过期，我们已将其从文件中删除。请使用/v1/returns/rfbs/action/set。 |
| `/v2/returns/rfbs/compensate` | `removed_method` | 2026-08-11 | `/v1/returns/rfbs/action/set` | /v2/returns/rfbs/compensate 这些方式已过期，我们已将其从文件中删除。请使用/v1/returns/rfbs/action/set。 |
| `/v2/returns/rfbs/verify` | `removed_method` | 2026-08-11 | `/v1/returns/rfbs/action/set` | /v2/returns/rfbs/verify 这些方式已过期，我们已将其从文件中删除。请使用/v1/returns/rfbs/action/set。 |
| `/v2/returns/rfbs/receive-return` | `removed_method` | 2026-08-11 | `/v1/returns/rfbs/action/set` | /v2/returns/rfbs/receive-return 这些方式已过期，我们已将其从文件中删除。请使用/v1/returns/rfbs/action/set。 |
| `/v2/returns/rfbs/return-money` | `removed_method` | 2026-08-11 | `/v1/returns/rfbs/action/set` | /v2/returns/rfbs/return-money 这些方式已过期，我们已将其从文件中删除。请使用/v1/returns/rfbs/action/set。 |
| `/v3/products/info/attributes` | `deprecated_method`, `removed_method` | 2026-07-10 | `/v4/product/info/attributes` | /v3/products/info/attributes 该方法已过时，已从文档中删除。请切换到新版本 /v4/product/info/attributes。 |
| `/v2/chat/list` | `removed_method` | 2026-06-09 | `/v3/chat/list` | /v2/chat/list 该方式已过期，我们已将其从文件中删除。请使用 /v3/chat/list。 |
| `/v1/analytics/average-delivery-time/details` | `removed_method` | 2026-05-19 | 无 | /v1/analytics/average-delivery-time/details 该方式已过期，我们已将其从文件中删除。 |
| `/v1/analytics/average-delivery-time` | `removed_method` | 2026-05-19 | 无 | /v1/analytics/average-delivery-time 该方式已过期，我们已将其从文件中删除。 |
...
| `/v1/seller-actions/create/ozon-card-discount` | `removed_method` | 2026-04-14 | 无 | /v1/seller-actions/create/ozon-card-discount 该促销活动已无法使用，相关方法已从文档中删除。 |
...
| `/v2/chat/history` | `removed_method` | 2026-02-20 | `/v3/chat/history` | /v2/chat/history 该方式已过期，我们已将其从文件中删除。请使用 /v3/chat/history。 |
| `/v2/fbs/posting/sent-by-seller` | `removed_method` | 2026-01-20 | 无 | /v2/fbs/posting/sent-by-seller 该方式已过期，我们已将其从文件中删除。 |
| `/v5/fbs/posting/product/exemplar/create-or-get` | `deprecated_method`, `removed_method` | 2026-01-13 | 无 | /v5/fbs/posting/product/exemplar/create-or-get 方法已过时， 已从 文档中移除。 |
| `/v4/fbs/posting/product/exemplar/set` | `deprecated_method`, `removed_method` | 2026-01-13 | 无 | /v4/fbs/posting/product/exemplar/set 方法已过时， 已从 文档中移除。 |
| `/v5/fbs/posting/product/exemplar/set` | `deprecated_method`, `removed_method` | 2026-01-13 | 无 | /v5/fbs/posting/product/exemplar/set 方法已过时， 已从 文档中移除。 |
| `/v4/fbs/posting/product/exemplar/status` | `deprecated_method`, `removed_method` | 2026-01-13 | 无 | /v4/fbs/posting/product/exemplar/status 方法已过时， 已从 文档中移除。 |
...
| `/v1/conditional-cancellation/get` | `removed_method` | 2025-09-03 | `/v2/conditional-cancellation/list` | /v1/conditional-cancellation/get 这些方式已过期，我们已将其从文件中删除。请使用 /v2/conditional-cancellation/list。 |
| `/v1/conditional-cancellation/list` | `removed_method` | 2025-09-03 | `/v2/conditional-cancellation/list` | /v1/conditional-cancellation/list 这些方式已过期，我们已将其从文件中删除。请使用 /v2/conditional-cancellation/list。 |
| `/v1/conditional-cancellation/approve` | `removed_method` | 2025-09-03 | `/v2/conditional-cancellation/approve` | /v1/conditional-cancellation/approve 该方式已过期，我们已将其从文件中删除。请使用 /v2/conditional-cancellation/approve。 |
| `/v1/conditional-cancellation/reject` | `removed_method` | 2025-09-03 | `/v2/conditional-cancellation/reject` | /v1/conditional-cancellation/reject 该方式已过期，我们已将其从文件中删除。请使用 /v2/conditional-cancellation/reject。 |
| `/v2/chat/list` | `deprecated_method` | 2025-07-28 | `/v3/chat/list` | /v2/chat/list 该方法将于未来停用。请改用 /v3/chat/list。 |
| `/v1/product/upload_digital_codes` | `deprecated_method`, `removed_method` | 2025-07-01 | 无 | /v1/product/upload_digital_codes 方法已过时， 已从 文档中移除。 |
| `/v1/product/upload_digital_codes/info` | `deprecated_method`, `removed_method` | 2025-07-01 | 无 | /v1/product/upload_digital_codes/info 方法已过时， 已从 文档中移除。 |
| `/v3/products/info/attributes` | `deprecated_method` | 2025-06-19 | `/v4/product/info/attributes` | /v3/products/info/attributes 该方法已过时。请切换到新版本 /v4/product/info/attributes。 |
| `/v1/conditional-cancellation/get` | `deprecated_method` | 2025-06-19 | `/v2/conditional-cancellation/list` | /v1/conditional-cancellation/get 方法即将过时，并将于2025年8月3日停用。请改用 /v2/conditional-cancellation/list。 |
| `/v1/conditional-cancellation/list` | `deprecated_method` | 2025-06-03 | `/v2/conditional-cancellation/list` | /v1/conditional-cancellation/list 方法即将过时，并将于2025年8月3日停用。请切换到新版本 /v2/conditional-cancellation/list。 |
| `/v1/conditional-cancellation/approve` | `deprecated_method` | 2025-06-03 | `/v2/conditional-cancellation/approve` | /v1/conditional-cancellation/approve 方法即将过时，并将于2025年8月3日停用。请切换到新版本 /v2/conditional-cancellation/approve。 |
| `/v1/conditional-cancellation/reject` | `deprecated_method` | 2025-06-03 | `/v2/conditional-cancellation/reject` | /v1/conditional-cancellation/reject 方法即将过时，并将于2025年8月3日停用。请切换到新版本 /v2/conditional-cancellation/reject。 |
| `/v1/product/import/stocks` | `deprecated_method`, `removed_method` | 2025-05-27 | `/v2/products/stock` | /v1/product/import/stocks 该方法已过时，已从文档中删除。请改用 /v2/products/stock。 |
| `/v2/chat/history` | `deprecated_method` | 2025-05-13 | `/v3/chat/history` | /v2/chat/history 方法即将过时，并将于2025年7月13日停用。请切换到新版本 /v3/chat/history。 |
| `/v1/finance/realization` | `deprecated_method`, `removed_method` | 2025-05-06 | `/v2/finance/realization` | /v1/finance/realization 该方法已过时，已从文档中删除。 请改用 /v2/finance/realization。 |
| `/v1/product/import/stocks` | `deprecated_method` | 2025-05-06 | `/v2/products/stocks` | /v1/product/import/stocks 方法将于2025年5月27日停用。请改用 /v2/products/stocks。 |
| `/v1/actions/hotsales/activate` | `deprecated_method`, `removed_method` | 2025-03-11 | 无 | /v1/actions/hotsales/activate 方法已过时，已从文档中移除。 |
| `/v1/actions/hotsales/deactivate` | `deprecated_method`, `removed_method` | 2025-03-11 | 无 | /v1/actions/hotsales/deactivate 方法已过时，已从文档中移除。 |
| `/v1/actions/hotsales/list` | `deprecated_method`, `removed_method` | 2025-03-11 | 无 | /v1/actions/hotsales/list 方法已过时，已从文档中移除。 |
| `/v1/actions/hotsales/products` | `deprecated_method`, `removed_method` | 2025-03-11 | 无 | /v1/actions/hotsales/products 方法已过时，已从文档中移除。 |
| `/v2/product/info` | `removed_method` | 2025-03-10 | `/v3/product/info/list` | /v2/product/info 该方法已过期，我们已将其从文件中删除。请使用 /v3/product/info/list。 |
| `/v4/product/info/prices` | `removed_method` | 2025-02-18 | 无 | /v4/product/info/prices 该方式已过期，我们已将其从文件中删除。 |
| `/v3/returns/company/fbs` | `removed_method` | 2025-02-18 | `/v1/returns/list` | /v3/returns/company/fbs 该方式已过期，我们已将其从文件中删除。请使用 /v1/returns/list. |
| `/v1/report/returns/create` | `removed_method` | 2025-02-18 | 无 | /v1/report/returns/create 该方式已过期，我们已将其从文件中删除。 |
| `/v2/product/info/list` | `removed_method` | 2025-02-17 | `/v3/product/info/list` | /v2/product/info/list 该方式已过期，我们已将其从文件中删除。请使用 /v3/product/info/list。 |
...
| `/v1/product/pictures/info` | `removed_method` | 2025-02-10 | `/v2/product/pictures/info` | /v1/product/pictures/info 该方式已过期，我们已将其从文件中删除。请使用 /v2/product/pictures/info。 |
...
| `/v1/actions/candidates` | 2025-12-23 | `added_field` | /v1/actions/candidates 添加了参数 result.products.current_boost、result.products.price_min_elastic、result.products.price_max_elastic、result.products.min_boost 和 result.products.max_boost 到方法的响应中。 | [来源](https://docs.ozon.ru/api/seller/zh/#section/20251223) |
| `/v1/actions/candidates` | 2025-05-15 | `added_field` | /v1/actions/candidates 添加了参数 result.products.alert_max_action_price_failed 和 result.products.alert_max_action_price 到方法的响应中。 | [来源](https://docs.ozon.ru/api/seller/zh/#section/2025515) |
| `/v1/actions/candidates` | 2025-03-13 | `added_field`, `deprecated_field` | /v1/actions/candidates 我们已将 offset 参数标记为已弃用，并添加了 last_id分页参数。 | [来源](https://docs.ozon.ru/api/seller/zh/#section/2025313) |
...
| `/v1/carriage/pass/create` | 2026-07-07 | `added_field` | /v1/carriage/pass/create 在方法请求中添加了参数arrival_passes.arrival_time、arrival_passes.tracking_number和arrival_passes.tracking_url。 | [来源](https://docs.ozon.ru/api/seller/zh/#section/202677) |
...
| `/v2/product/pictures/info` | 2026-07-10 | `removed_field` | /v2/product/pictures/info 已从方法响应中删除了items.photo_360参数。 | [来源](https://docs.ozon.ru/api/seller/zh/#section/2026710) |
...
| `/v6/fbs/posting/product/exemplar/create-or-get` | 2025-09-29 | `added_field` | /v6/fbs/posting/product/exemplar/create-or-get 已更新products.exemplars.marks参数的描述，并在方式响应中添加了products.has_imei参数。 | [来源](https://docs.ozon.ru/api/seller/zh/#section/2025929) |
